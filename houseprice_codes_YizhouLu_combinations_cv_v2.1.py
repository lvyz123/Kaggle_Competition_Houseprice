...
prediction_model_lr = ElasticNetCV(eps=1e-4,max_iter=1000000,n_alphas=100,l1_ratio=0.95,cv=k_fold,n_jobs=-1)
...
print(prediction_model_lr.best_score_, alpha_best)

# Learning Curve
axes = plt.subplot(2,2,1)
lc.learning_curve_plot(ElasticNet(max_iter=100000,alpha=alpha_best,l1_ratio=0.95),train_X,train_y,cv_X,cv_y)
